...
Verwandt: [README.de.md](./README.de.md) · [docs/ARCHITECTURE.md](./docs/ARCHITECTURE.md) ·
[docs/ROADMAP.md](./docs/ROADMAP.md) · [SECURITY.de.md](./SECURITY.de.md) · [docs/PLUGINS.md](./docs/PLUGINS.md)
...
Sicherheitsrelevante Funde bitte **nicht** als öffentliches Issue, sondern nach [SECURITY.de.md](./SECURITY.de.md).
