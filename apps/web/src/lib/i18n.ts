...
const dict = {
  de: {
    ...
    openWorkspace: 'Im Workspace öffnen',
    openWorkspaceHint: 'Datei bleibt lokal — im Workspace weiterarbeiten: mehrere Schritte, Undo, Export in einem Tab.',
    workspace: 'Workspace',
    sessions: 'Sitzungen',
    sessionsHint: 'Workspace-Sitzungen (OPFS) — Dateien, Schritte, Funde. Öffnen führt in den Workspace.',
    openSession: 'Öffnen',
  ...
  en: {
    ...
    openWorkspaceHint: 'File stays local — continue in the workspace: several steps, undo, export in one tab.',
    workspace: 'Workspace',
    sessions: 'Sessions',
    sessionsHint: 'Workspace sessions (OPFS) — files, steps, findings. Open leads into the workspace.',
    openSession: 'Open',
