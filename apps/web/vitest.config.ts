...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@neotools/license': root('../../packages/license/src/index.ts'),
      ...
      '@neotools/tools-office': root('../../packages/tools-office/src/index.ts'),
      '@neotools/tools-media': root('../../packages/tools-media/src/index.ts'),
      '@neotools/tools-archive': root('../../packages/tools-archive/src/index.ts'),
