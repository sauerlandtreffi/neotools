...
Entwicklungs-Wellen geführt (Commit-Hashes in Klammern, Branch `main`, kein Remote).
...
- **Launch-Seiten:** `/preise` · `/en/pricing`, `/vergleich/{ilovepdf,smallpdf,adobe-acrobat,ihatepdf}` ·
