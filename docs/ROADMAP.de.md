...
Verwandt: [BACKLOG.de.md](./BACKLOG.de.md) · [ARCHITECTURE.de.md](./ARCHITECTURE.de.md)
...
| image-ai | 9 | `a11y-easy-read`, `a11y-sign-friendly` (plus Hintergrund, Gesichter, Objekterkennung, Alt-Text, Super-Res/Denoise-Showcases) |
| creator | 22 | eigenes Paket `packages/tools-creator`; Kategorie „Creator & Social“ |
| dach | 12 | — |
| office | 32 | — |
